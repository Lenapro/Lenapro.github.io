...
<div class="form col-md-7" style="margin-left: 30%; margin-bottom: 10%;">
            <h3 class="mb-5" style="margin-left: 20%;">Inscrivez-vous</h3>
            <form class="text-center" method="post" action="modelInscription.php">
               <div class="row">
                   <div class="col-md-8">
            ...
            <div class="row mt-4">
                <div class="col-md-8">
                    <button class="btn btn-outline-primary" type="submit"  style="width: 100%;"> Inscription </button>
                 </div>
            </div>
            </form>
      </div>